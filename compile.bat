...
:: ==================== COMPILE MAIN SCRIPT ====================
echo [2/6] Compiling main script...
echo.
...
echo [3/6] Creating output directory structure...
::delete first 
if exist "%OUTPUT_DIR%" (
...
echo [4/6] Deploying main executable...
...
:: ==================== COPY AHK2 FILES ====================
echo [6/6] Copying script files and configurations...
echo.
...
echo   + version.txt
:: last step create compressed zip of the output directory
echo.
:: ==================== CREATE ZIP FILE ====================
echo [5/6] Creating ZIP archive of the output directory...
...
echo You can copy this entire folder to any Windows system.
exit /b 0
